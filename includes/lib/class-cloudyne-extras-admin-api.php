 ...
 * Admin API class.
 */
class Cloudyne_Extras_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'cloudyne-extras' ) . '" data-uploader_button_text="' . __( 'Use image', 'cloudyne-extras' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'cloudyne-extras' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'cloudyne-extras' ) . '" />' . "\n";
